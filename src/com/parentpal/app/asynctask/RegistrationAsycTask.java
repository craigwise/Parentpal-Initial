 ...
 *
 */
public class RegistrationAsycTask extends AsyncTask<Object, Void, String> {
	...
	protected String doInBackground(Object... objects) {
		...
		if (connection.isConnected()) {
			...
			nameValuePair.add(new BasicNameValuePair("fullname",(String) objects[1]));
			nameValuePair.add(new BasicNameValuePair("username",(String) objects[2]));
			nameValuePair.add(new BasicNameValuePair("password",(String) objects[3]));
			nameValuePair.add(new BasicNameValuePair("emailID", (String) objects[4]));
			nameValuePair.add(new BasicNameValuePair("phoneNumber",(String) objects[5]));

			return connection.httpPOST(Utility.API_REGISTRATION_PAGE, nameValuePair);
			...
			try {
				...
				if (resObject.has("success")) {
					...
					if (resObject.getInt("success") == 1) {
						...
						Utility.setStringPreference(mContext, Utility.KEY_CUST_ID, resObject.getString("customerID"));
					}else {
