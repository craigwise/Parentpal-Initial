 ...
 */
public class ParentpalScanditScannner extends Activity implements ScanditSDKListener {
    ...
    public static final String sScanditSdkAppKey = "O3lnInhQEeOV7lXusnmQL0y1pSkRsAq+WVQBK1mz9Hg";
    ...
    public void didScanBarcode(String barcode, String symbology) {
        ...
        returnIntent.putExtra("resultBarcode",cleanedBarcode);
    ...
    public void didManualSearch(String entry) {
    	...
    	returnIntent = new Intent();
        returnIntent.putExtra("resultBarcode",entry);
        setResult(RESULT_OK,returnIntent);     
        finish();
